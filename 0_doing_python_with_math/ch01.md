...
```
>>> [def is\_factor(a, b):]  # Define a function to check if a is a factor of b
...
```
>>> [is\_factor(4, 1024)]  # Check if 4 is a factor of 1024
True
```
...
           if b % i == 0:  # If b divided by i leaves no remainder
               print(i)  # Print i
\
